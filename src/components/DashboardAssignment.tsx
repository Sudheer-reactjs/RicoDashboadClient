...
import { NextIcon, PervIcon, ViewIcon } from '@/utils/svgicon';
            ...
            <tr key={item.id}>
              ...
              <td>
                {isPastDate(item.renewalDate) ? (
                  <Link href="/renewplane" style={getStyle('Renew Subscription')}>Renew Subscription</Link>
                ) : (
                  item.renewalDate
                )}
              </td>
              <td>
                {item.chatWithClinician === 'Start Chat' ? (
                  ...
                  <Link href="/renewplane" style={getStyle('Renew Subscription')}>{item.chatWithClinician}</Link>
                ) : (
              ...
              <td>
                {item.videoChat === 'Start Video Call' ? (
                  ...
                  <Link href="/renewplane" style={getStyle('Renew Subscription')}>{item.videoChat}</Link>
                ) : (
              ...
              <td>
                <Link href="/care-team"><ViewIcon /></Link>
              </td>
            </tr>
          ))}
        </tbody>
